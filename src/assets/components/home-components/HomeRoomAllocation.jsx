...
export default function HomeRoomAllocation() {
  ...
  if (loading) {
    return (
      <div className='flex justify-center items-center h-screen gap-2'>
        <BounceLoader color="#34ab53" size={80} /> <span className="font-bold">Loading Available Rooms...</span>
      </div>
    );
  }

  return (
    <div className="p-6 mt-18 md:mt-24 md:mx-6">
